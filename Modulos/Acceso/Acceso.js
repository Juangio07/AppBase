...
const STORAGE_KEY =
    "FixelarBase_configuracion_empresa_v1";
...
function aplicarTemaNegocio(tema) {
    // La identidad oficial de FixelarBase no puede ser reemplazada por datos locales antiguos.
    tema = {
        primary: "#2563FF",
        hover: "#0EA5FF",
        light: "#22D3EE",
